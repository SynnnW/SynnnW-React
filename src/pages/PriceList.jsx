...
const CATEGORIES = [
  ...
  },
  {
    ...
    desc: 'Website custom sesuai kebutuhan kamu',
    items: [
      {
        id: 'w1', name: 'Website Vibe Code (AI-Assisted)', icon: 'fa-wand-magic-sparkles',
        price: 100000, origPrice: 200000, unit: '/ project',
        badge: 'Paling Cepat',
        short: 'Pakai AI tools, cepat & efisien',
        desc: 'Pengembangan website menggunakan AI-assisted tools (vibe coding). Cocok untuk kebutuhan cepat dengan hasil yang tetap profesional. Menggunakan Bolt.new, Lovable, atau tools serupa.\n\n✦ Proses super cepat (1-3 hari)\n✦ React / Next.js modern\n✦ Design responsif mobile-first\n✦ Bisa request revisi 2x\n✦ File project diberikan\n\n⚠️ Untuk kebutuhan unik / sangat custom, disarankan paket Pure Code',
        syarat: true,
      },
      {
        id: 'w2', name: 'Website JSX / Vite', icon: 'fa-code',
        price: 250000, origPrice: 400000, unit: '/ project',
        badge: null,
        short: 'React + Vite, clean & modern',
        desc: 'Website dibangun dari nol menggunakan React + Vite. Pure manual code, bukan AI generated. Kamu dapat full source code dan bisa dikembangkan lebih lanjut.\n\n✦ React + Vite (modern stack)\n✦ Komponen reusable\n✦ Animasi & interaksi smooth\n✦ Optimasi performa\n✦ Source code lengkap diberikan\n✦ Revisi 3x',
        syarat: true,
      },
      {
        id: 'w3', name: 'Website Pure HTML/CSS/JS', icon: 'fa-file-code',
        price: 150000, origPrice: 250000, unit: '/ project',
        badge: null,
        short: 'Ringan, cepat, tanpa framework',
        desc: 'Website klasik menggunakan HTML, CSS, dan JavaScript murni. Sangat ringan dan cepat diload. Ideal untuk landing page, undangan digital, atau portofolio sederhana.\n\n✦ Tidak butuh hosting khusus\n✦ Load super cepat\n✦ Tidak tergantung framework\n✦ SEO-friendly by default\n✦ File siap deploy\n✦ Revisi 3x',
        syarat: true,
      },
      {
        id: 'w4', name: 'Website Full Custom', icon: 'fa-gem',
        price: 350000, origPrice: 600000, unit: '/ project',
        badge: 'Premium',
        short: 'Full custom sesuai desain & brief kamu',
        desc: 'Paket premium untuk website yang benar-benar custom — dari desain hingga fungsi. Bisa pakai stack apapun sesuai kebutuhan. Konsultasi mendalam sebelum pengerjaan.\n\n✦ Konsultasi & brief mendalam\n✦ Desain dari nol (Figma/langsung code)\n✦ Stack sesuai kebutuhan\n✦ Integrasi CMS/backend opsional\n✦ Dokumentasi kode\n✦ Revisi 5x + support 2 minggu',
        syarat: true,
      },
    ],
  },
    ...
    items: [
      {
        ...
        badge: 'Hemat 40%',
        short: 'Domain + Hosting + Website Portofolio',
        desc: 'Paket lengkap untuk kamu yang mau punya website portofolio atau personal branding. Semuanya diurus, kamu tinggal siapkan konten!\n\n✦ Domain .com (1 tahun)\n✦ Hosting Basic (1 bulan)\n✦ Website HTML/CSS/JS atau Vite\n✦ Design clean & modern\n✦ SSL gratis\n✦ Revisi 3x\n\n💡 Cocok untuk: mahasiswa, freelancer, kreator',
        syarat: true,
      },
      {
        ...
        badge: 'Best Value',
        short: 'Domain + Hosting + Website + Backend',
        desc: 'Paket paling lengkap untuk bisnis yang serius. Termasuk website custom dengan backend Firebase dan notifikasi Telegram.\n\n✦ Domain .id atau .com (1 tahun)\n✦ Hosting Pro (1 bulan)\n✦ Website React/Vite custom\n✦ Firebase database\n✦ Telegram bot notifikasi\n✦ SSL + email domain\n✦ Revisi 5x + support 1 bulan\n\n💡 Cocok untuk: UMKM, brand, komunitas',
        syarat: true,
      },
      {
          ...
          <div className="pl-sheet-overlay pl-sheet-open" onClick={() => setCartOpen(false)}>
            <div className="pl-sheet pl-cart-sheet" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="pl-sheet-scroll">
                ...
                <a href="/contact" className="pl-sheet-btn-add" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
                  <i className="fa-solid fa-arrow-right" />
                  <span>Lanjut ke Form Kontak</span>
                </a>
              </div>
            </div>
          </div>
