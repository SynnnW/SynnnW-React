...
const DATA = {
  title:      'Waktu Untuk Diri',
  titleSub:   'Me Time - Time For Yourself',
  year:       '2026',
  production: 'Not An Ordinary Teenage Competition',
  pembina:    'UNEJ Faculty of Nursing (FKEP)',
  editor:    'Aldo Leo Saputra',
  youtubeId:  null,
  badges:     ['Research Poster', 'Mental Health'],
  awards:     ['🏥 Not An Ordinary Teenage — UNEJ FKEP'],

  descEn: 'Research poster for "Not An Ordinary Teenage" competition highlighting the importance of personal time (Me Time) and self-care for teenage mental health. Explores how taking time for oneself helps reduce stress, improve emotional well-being, and build healthy habits.',
  descId: 'Poster riset untuk kompetisi "Not An Ordinary Teenage" yang menyoroti pentingnya waktu pribadi (Me Time) dan perawatan diri bagi kesehatan mental remaja. Mengeksplorasi bagaimana meluangkan waktu untuk diri sendiri membantu mengurangi stres, meningkatkan kesejahteraan emosional, dan membangun kebiasaan sehat.',

  crew: [
    { role: 'Researcher & Designer', name: 'Aldo Leo Saputra' },
  ],
};
...
.wd-hero-bg {
  ...
  background:
    radial-gradient(ellipse 55% 55% at 85% 15%, rgba(236,72,153,0.14) 0%, transparent 60%),
...
.wd-badge-poster { background: rgba(236,72,153,0.12); border: 1px solid rgba(236,72,153,0.3); color: #ec4899; }
...
export default function WorkDetail24({ lang = 'id' }) {
    ...
    <div className="wd-page" ref={pageRef}>
      <section className="wd-hero">
        ...
        <div className="wd-badges wd-reveal wd-d1">
          ...
          {d.awards.map((a, i) => (
            <span key={`award-${i}`} className="wd-badge wd-badge-award">
              {a}
            </span>
          ))}
        </div>
      ...
      <section className="wd-section">
        ...
        <h2 className="wd-sec-title wd-reveal wd-d1">
          View the <em>Research.</em>
        </h2>

        <div className="wd-yt-wrap wd-reveal wd-d2">
          <iframe
            src="https://drive.google.com/file/d/19rxbhvCMWx5OUXftujElSyqrJ-cT_MnS/preview"
            title="Me Time Poster"
            allow="autoplay; encrypted-media"
            style={{ width: '100%', aspectRatio: '3/4', border: 'none', display: 'block' }}
          />
          <div className="wd-yt-footer">
            <div className="wd-yt-title-row">
              <span className="wd-yt-film-name">Waktu Untuk Diri</span>
              <span className="wd-yt-sub">Research Poster · UNEJ FKEP</span>
            </div>
          </div>
        </div>
      ...
      <section className="wd-section">
        <span className="wd-sec-label wd-reveal">02 / Researcher</span>
        <h2 className="wd-sec-title wd-reveal wd-d1">The <em>Author.</em></h2>
