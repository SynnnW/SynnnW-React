...
const DATA = {
  title:      'Lanyard Kelas',
  titleSub:   'Class Identity & Unity',
  year:       '2026',
  production: 'School Design',
  pembina:    null,
  editor:     'Aldo Leo Saputra',
  youtubeId:  null,
  badges:     ['Lanyard Design', 'Branding'],
  awards:     [],

  descEn: 'Custom lanyard design for class identity featuring unified branding elements that strengthen class unity and recognition. Modern design with meaningful colors and typography that represents the spirit and values of the class community.',
  descId: 'Design lanyard custom untuk identitas kelas dengan elemen branding terpadu yang memperkuat kesatuan dan pengenalan kelas. Desain modern dengan warna bermakna dan tipografi yang merepresentasikan semangat dan nilai komunitas kelas.',
...
.wd-hero-bg {
  ...
  background:
    radial-gradient(ellipse 55% 55% at 85% 15%, rgba(139,92,246,0.14) 0%, transparent 60%),
...
.wd-badge-lany { background: rgba(139,92,246,0.12); border: 1px solid rgba(139,92,246,0.3); color: #8b5cf6; }
.wd-badge-brand { background: rgba(139,92,246,0.12); border: 1px solid rgba(139,92,246,0.3); color: #8b5cf6; }
.wd-hero-title {
...
export default function WorkDetail25({ lang = 'id' }) {
    ...
    <div className="wd-page" ref={pageRef}>
      <section className="wd-hero">
        ...
        <div className="wd-breadcrumb wd-reveal">
          Work <span>/ Lanyard Design</span>
        </div>

        <div className="wd-badges wd-reveal wd-d1">
          {d.badges.map((b, i) => (
            <span key={i} className={`wd-badge wd-badge-${b === 'Branding' ? 'brand' : 'lany'}`}>
              {b}
            </span>
          ))}
        </div>
      ...
      <section className="wd-section">
        ...
        <div className="wd-yt-wrap wd-reveal wd-d2">
          <iframe
            src="https://drive.google.com/file/d/1RTirN6IkCPsQoEwupn72_AXPDts72doz/preview"
            title="Lanyard Kelas"
          ...
          <div className="wd-yt-footer">
            <div className="wd-yt-title-row">
              <span className="wd-yt-film-name">Lanyard Kelas</span>
              <span className="wd-yt-sub">Class Design · School Branding</span>
            </div>
          </div>
        </div>
