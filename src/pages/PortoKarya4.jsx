...
export default function PortoKarya4() {
      ...
      <div className="k4-page">
        ...
        <div className="k4-nav">
          <button className="k4-nav-btn" onClick={() => navigate('/porto')}>
            <i className="fa-solid fa-arrow-left" /> Kembali ke Work
          </button>
          <button className="k4-nav-btn" onClick={() => navigate('/porto/karya1')}>
            <i className="fa-solid fa-arrow-left" /> Karya Sebelumnya
          </button>
        </div>
