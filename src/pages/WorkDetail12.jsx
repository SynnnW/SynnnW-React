...
const DATA = {
  title:      'Teaser MPLS 2024',
  titleSub:   'ALTERIO',
  year:       '2024',
  production: 'SMAN 1 Kraksaan',
  pembina:    null,
  editor:     'Aldo Leo Saputra',
  youtubeId:  'PhxxqPwSyw8',
  badges:     ['Teaser', 'Video', 'Event'],
  awards:     [],

  descEn: `A time-travel teaser for SMAN 1 Kraksaan's MPLS (new student orientation). ` +
          `Alvin finds a mysterious clock, accidentally activates it, and ends up witnessing ` +
          `the moment their class name — ALTERIO 47 — was decided. Made to hype up the incoming batch.`,

  descId: `Teaser untuk MPLS SMAN 1 Kraksaan. Alvin nemu jam misterius, nggak sengaja ` +
          `ngaktifin, dan tiba-tiba udah di tahun 2022 — nonton rapat OSIS nentuin nama ` +
          `angkatan. Terus nulis 'ALTERIO 47' di tembok. Dibuat buat nyemangatin angkatan baru.`,
...
.wd-synopsis-box { background: rgba(139,92,246,0.05); border: 1px solid rgba(139,92,246,0.18); border-left: 3px solid var(--accent2); border-radius: 14px; padding: 24px 28px; margin-top: 28px; }
  ...
  return (
    <div className="wd-page" ref={pageRef}>
      <section className="wd-hero">
        ...
        <div className="wd-breadcrumb wd-reveal">Work <span>/ Teaser</span></div>
        <div className="wd-badges wd-reveal wd-d1">
          {d.badges.map((b, i) => (
            <span key={i} className={`wd-badge wd-badge-${b === 'Teaser' ? 'teaser' : b === 'Video' ? 'video' : 'event'}`}>
      ...
      <section className="wd-section">
        <span className="wd-sec-label wd-reveal">01 / Teaser</span>
        <h2 className="wd-sec-title wd-reveal wd-d1">Watch the <em>Teaser.</em></h2>
      ...
      <section className="wd-section">
        ...
        <h2 className="wd-sec-title wd-reveal wd-d1">About This <em>Teaser.</em></h2>
