...
const DATA = {
  title:      'Lanyard Ekstrakurikuler',
  titleSub:   'Student Activity & Engagement',
  year:       '2026',
  production: 'School Design',
  pembina:    null,
  editor:     'Aldo Leo Saputra',
  youtubeId:  null,
  badges:     ['Lanyard Design', 'Activity'],
  awards:     [],

  descEn: 'Lanyard design for extracurricular activities featuring vibrant colors and meaningful graphics that represent student involvement and active participation in school programs. The design strengthens community spirit and creates visual identity for various extracurricular organizations.',
  descId: 'Design lanyard untuk kegiatan ekstrakurikuler dengan warna cerah dan grafis bermakna yang merepresentasikan keterlibatan siswa dalam program sekolah. Desain memperkuat semangat komunitas dan menciptakan identitas visual untuk berbagai organisasi ekstrakurikuler.',
...
.wd-hero-bg {
  ...
  background:
    radial-gradient(ellipse 55% 55% at 85% 15%, rgba(245,158,11,0.14) 0%, transparent 60%),
...
.wd-badge-lany { background: rgba(245,158,11,0.12); border: 1px solid rgba(245,158,11,0.3); color: #f59e0b; }
.wd-badge-act { background: rgba(245,158,11,0.12); border: 1px solid rgba(245,158,11,0.3); color: #f59e0b; }
.wd-hero-title {
...
export default function WorkDetail27({ lang = 'id' }) {
    ...
    <div className="wd-page" ref={pageRef}>
      <section className="wd-hero">
        ...
        <div className="wd-breadcrumb wd-reveal">
          Work <span>/ Extracurricular Design</span>
        </div>

        <div className="wd-badges wd-reveal wd-d1">
          {d.badges.map((b, i) => (
            <span key={i} className={`wd-badge wd-badge-${b === 'Activity' ? 'act' : 'lany'}`}>
              {b}
            </span>
          ))}
        </div>
        ...
        <div className="wd-hero-meta wd-reveal wd-d3">
          ...
          <div className="wd-meta-item">
            <span className="wd-meta-label">Type</span>
      ...
      <section className="wd-section">
        ...
        <div className="wd-yt-wrap wd-reveal wd-d2">
          <iframe
            src="https://drive.google.com/file/d/1qw6qWU-yVGA_d15LCFCzSalO1TB00XN7/preview"
            title="Lanyard Ekstrakurikuler"
          ...
          <div className="wd-yt-footer">
            <div className="wd-yt-title-row">
              <span className="wd-yt-film-name">Lanyard Ekstrakurikuler</span>
              <span className="wd-yt-sub">Activity Design · Student Engagement</span>
            </div>
          </div>
        </div>
