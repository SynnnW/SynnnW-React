...
const DATA = {
  ...
  descEn: 'Saka\'s bike chain breaks on the way to school. Everyone passes by. One teacher stops — not with words, but with action. A quiet film about the kind of help that doesn\'t make a scene.',
  descId: 'Rantai sepeda Saka lepas di tengah jalan. Semua orang lewat. Satu guru berhenti — bukan dengan kata-kata, tapi dengan tindakan. Film yang tenang tentang pertolongan yang nggak perlu penonton.',
  ...
  crew: [
    ...
    { role: 'Juru Kamera',         name: 'Zafa Islamay Pratama Putra, Alvarel Bagasdika Pratama' },
    { role: 'Sound-man',           name: 'Aci Benaya Sasongko, Erika Puspita Sari' },
    { role: 'Divisi Artistik',     name: 'Hermawan Ibra Wicaksono, Fikriyyah Putri Salsabila, Diva Triwahyuningsih' },
    { role: 'Make Up & Wardrop',   name: 'Qomariya Agustin' },
    { role: 'Pencatat Adegan',     name: 'Emelie Naura Ramadhani, Shahwah Nabila Anadi' },
    { role: 'Lighting-man',        name: 'Royfando Bryanda Arkananta' },
    { role: 'Editor',              name: 'Aldo Leo Saputra' },
  ],

  cast: [
    'Robith Bil Haq Zidni Ilma (Saka)',
    'Mohammad Adibillah (Pak Egar)',
    'Santi Novita (Guru A)',
    'Awan Wijanarko (Guru B)',
    'Dwi Agus Prasetyo (Supir Pick-up)',
    'Extras: Diva Triwahyuningsih, Erika Puspita Sari, Trizha Nur Hidayah Putri',
  ],
