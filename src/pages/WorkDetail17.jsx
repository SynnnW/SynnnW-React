...
const DATA = {
  ...
  titleSub:   'Competition 2025',
  year:       '2025',
  production: 'SMAN 1 Kraksaan — Provinsi Jawa Timur',
  pembina:    null,
  ...
  descEn: 'Competition video for the Anak Indonesia Hebat national gymnastics program — filmed and edited for SMAN 1 Kraksaan\'s provincial entry. Clean coverage, tight audio sync.',
  descId: 'Video lomba senam Anak Indonesia Hebat 2025, mewakili provinsi Jawa Timur dari SMAN 1 Kraksaan. Shoot dan edit bersih, sync audio ketat.',

  synopsis: null,

  crew: [
    { role: 'Editor & Audioman & Cameraman',  name: 'Aldo Leo Saputra' },
    { role: 'Cameraman 2',                    name: 'Hermawan Ibra Wicaksono' },
  ],
