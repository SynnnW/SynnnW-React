...
const FEATURES = [
  {
    ...
    name: "Sambutan Nama Personal per Tamu",
    desc: "Setiap tamu memasukkan namanya sendiri sebelum membuka undangan. Nama ini kemudian muncul di halaman amplop, hero section, dan form RSVP — memberikan pengalaman yang terasa personal dan intim, bukan undangan massal biasa.",
  },
  {
    icon: "fa-solid fa-film",
    name: "Loading Video & Transisi Prewedding",
    desc: "Video loading tampil otomatis saat pertama dibuka — portrait untuk HP, landscape untuk desktop. Setelah amplop dibuka, video prewedding memutar sebagai transisi sinematik sebelum konten utama muncul.",
  },
  {
    icon: "fa-solid fa-calendar-days",
    name: "Bento Grid Acara & Add to Calendar",
    desc: "Tiga acara (Akad Nikah + dua Resepsi) disajikan dalam desain bento grid yang elegan, lengkap dengan peta Google Maps embed dan tombol simpan ke enam platform kalender sekaligus — Google, iCal, Apple, Outlook, Microsoft365, dan Yahoo.",
  },
  {
    icon: "fa-solid fa-images",
    name: "Galeri Foto Prewedding Interaktif",
    desc: "Enam foto prewedding tampil dalam slider Swiper.js yang bisa digeser dengan jari. Dilengkapi pagination dots, tombol navigasi panah, autoplay, dan efek coverflow 3D. Tamu bisa mengetuk foto untuk membukanya di lightbox fullscreen.",
  },
  {
    icon: "fa-solid fa-comment-dots",
    name: "RSVP & Ucapan Real-Time via Telegram",
    desc: "Tamu mengisi form ucapan dan konfirmasi kehadiran yang langsung terkirim ke pembuat lewat Telegram Bot — beserta nama tamu, pesan, dan status hadir/tidak. Counter hadir dan tidak hadir terupdate otomatis.",
  },
  {
    icon: "fa-solid fa-envelope-open-text",
    name: "Wedding Gift & Amplop Digital",
    desc: "Kartu rekening BNI dan BCA tersembunyi di balik tombol toggle yang elegan. Nomor rekening bisa disalin satu ketukan. Tamu bisa mengunggah foto bukti transfer langsung dari HP dan mengirimkannya ke panitia lewat Telegram Bot.",
  },
];

const TECHS = [
  { icon: "fa-brands fa-html5", name: "HTML5", desc: "Struktur semantik untuk 6 slide" },
  { icon: "fa-brands fa-css3-alt", name: "CSS3", desc: "Glassmorphism, dark mode, CSS variables" },
  { icon: "fa-brands fa-js", name: "Vanilla JS", desc: "ES6+, state management, tanpa framework" },
  { icon: "fa-solid fa-paper-plane", name: "Telegram Bot API", desc: "Notifikasi RSVP & upload bukti transfer" },
  { icon: "fa-solid fa-rotate", name: "Swiper.js", desc: "Slider galeri foto prewedding 3D" },
  { icon: "fa-solid fa-wand-magic-sparkles", name: "AOS Library", desc: "Animasi scroll otomatis di seluruh elemen" },
];
...
const TAGS = [
  ...
  "Ripple Effect","Bento Grid","RSVP Form","Digital Envelope",
  "Google Maps Embed","Google Fonts","FontAwesome 6",
];
...
const PROCESSES = [
  {
    ...
    desc: "Merancang alur tiga gerbang (input nama → amplop → konten) beserta enam slide dengan isinya. Menentukan identitas visual Elegant Glass, tipografi serif premium, dan palet warna sebelum satu baris kode ditulis.",
    dur: "1–2 hari",
  },
  {
    num: "02",
    title: "Sistem Desain & Visual",
    desc: "Membangun design system dari nol — CSS variables global, glassmorphism cards, latar belakang adaptif desktop dan mobile untuk setiap slide, dua tema (terang/gelap), dan komponen tipografi dengan Amiri untuk kaligrafi Arab.",
    dur: "2–3 hari",
  },
  {
    num: "03",
    title: "Development & Integrasi",
    desc: "Membangun semua fitur interaksi: gerbang tiga tahap, video loading dan transisi, countdown timer, animasi AOS, Swiper gallery, bento grid acara, Add-to-Calendar, form RSVP, integrasi Telegram Bot untuk notifikasi dan RSVP, amplop digital dengan upload bukti transfer, haptic, dan ripple.",
    dur: "5–7 hari",
  },
  {
    num: "04",
    title: "Polish & Deploy",
    desc: "Optimasi performa (lazy loading foto, preload video), fine-tuning animasi di semua ukuran layar, pengujian di berbagai HP nyata, dan deployment ke GitHub Pages agar bisa diakses langsung dari HP tamu undangan.",
    dur: "1–2 hari",
    last: true,
  },
];
...
const GALLERY_ITEMS = [
  { src: "/assets/img/1.png", alt: "Gate 1 — Input Nama Tamu",        caption: "Gate 1 — Input Nama Tamu",        cls: "k2-gal-laptop-lg" },
  { src: "/assets/img/6.png", alt: "Slide Hero & Countdown Timer",    caption: "Slide Hero & Countdown Timer",    cls: "k2-gal-phone" },
  { src: "/assets/img/5.png", alt: "Gate 2 — Amplop Digital",         caption: "Gate 2 — Amplop Digital",         cls: "k2-gal-phone" },
  { src: "/assets/img/2.png", alt: "Bento Grid Rangkaian Acara",      caption: "Bento Grid Rangkaian Acara",      cls: "k2-gal-laptop-lg" },
  { src: "/assets/img/3.png", alt: "Swiper Gallery Prewedding",       caption: "Swiper Gallery Prewedding",       cls: "k2-gal-laptop-half" },
  ...
  return (
    <div
      style={{
        ...
        animation: "k2ModalIn 0.25s ease",
      }}
    >
      {/* overlay */}
      <div
    ...
    <>
      ...
      <div ref={pageRef}>
        ...
        <section style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "flex-end", padding: "0 80px 90px", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative", zIndex: 2, maxWidth: "780px" }}>
            ...
            <div className="reveal rv-d1" style={{
              ...
              Web Development &amp; Telegram Integration
            </div>
            ...
            <h1 className="reveal rv-d2" style={{
              ...
              Undangan<br />
              <em style={{ fontStyle: "italic", color: "var(--text-dim)" }}>Pernikahan Digital</em>
            </h1>

            {/* sub */}
            <p className="reveal rv-d3" style={{ fontSize: "0.92rem", color: "var(--text-dim)", maxWidth: "500px", lineHeight: 1.78, marginBottom: "36px" }}>
              Website undangan pernikahan interaktif — dibangun penuh dengan HTML, CSS, dan JS murni. Menyambut setiap tamu secara personal, menghadirkan video sinematik, RSVP real-time via Telegram Bot, dan enam halaman penuh konten yang hangat dalam satu pengalaman digital yang tak terlupakan.
            </p>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "start" }}>
            ...
            <div className="reveal rv-d1" style={{ paddingTop: "10px" }}>
              <p style={{ fontSize: "0.92rem", lineHeight: 1.9, color: "var(--text-dim)" }}>
                Website ini lahir dari keinginan untuk menghadirkan undangan pernikahan yang bukan sekadar dikirim lewat pesan — melainkan dialami. Dibangun sepenuhnya dengan HTML, CSS, dan JavaScript murni tanpa framework, undangan ini menyambut setiap tamu dengan menyebut namanya secara personal, membawa mereka melewati video loading yang sinematik, amplop digital interaktif, hingga enam halaman penuh konten yang kaya rasa.
              </p>
              <p style={{ fontSize: "0.92rem", lineHeight: 1.9, color: "var(--text-dim)", marginTop: "22px" }}>
                Setiap detail dirancang dengan sistem desain Elegant Glass yang konsisten — glassmorphism card, tipografi serif premium (Cormorant Garamond, Playfair Display, Amiri untuk kaligrafi Arab), latar belakang adaptif untuk desktop dan mobile, serta mode gelap dan terang yang mulus. Di balik layar, Telegram Bot bekerja diam-diam — setiap kali tamu membuka undangan atau mengirim ucapan, pembuat langsung mendapat notifikasi beserta nama tamu tersebut.
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="reveal" style={{
          ...
          {[
            { num: "6",  label: "Slide Halaman" },
            { num: "3",  label: "Acara Tercatat" },
            { num: "6",  label: "Platform Kalender" },
            { num: "∞",  label: "Doa & Berkah" },
          ].map((s, i) => (
        ...
        {/* ══════════════════════════════════════
            GALLERY
        ══════════════════════════════════════ */}
        <section id="k2-gallery-section" style={{ padding: "100px 80px", borderTop: "1px solid var(--border)" }}>
          ...
          <div className={`k2-gal-grid reveal rv-d2`}>
            {GALLERY_ITEMS.map((item, i) => (
              <div
                key={i}
                className={`k2-gal-item ${item.cls}`}
                onClick={() => !imgErrors[i] && openModal(item.src)}
              >
                {imgErrors[i] ? (
                  <div className="k2-gal-ph">
        ...
        <section style={{ padding: "100px 80px", borderTop: "1px solid var(--border)" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "20px" }}>
            {FEATURES.map((f, i) => {
              const delay = i % 3;
              return (
                <div key={i} className={`k2-feat-card reveal${delay ? ` rv-d${delay}` : ""}`}>
                  <div style={{
        ...
        <section style={{ padding: "100px 80px", borderTop: "1px solid var(--border)" }}>
          ...
          <div className="reveal rv-d3" style={{ display: "flex", flexWrap: "wrap", gap: "9px" }}>
            {TAGS.map((tag) => (
              <span key={tag} className="k2-tag">{tag}</span>
            ))}
          </div>
        </section>
        ...
        <div className="reveal" style={{
          ...
          <button className="k2-proj-nav" onClick={() => navigate("/porto")}>
          ...
          <button className="k2-proj-nav" onClick={() => navigate("/porto/karya3")} style={{ justifyContent: "flex-end" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: "4px", textAlign: "right" }}>
              ...
              <span style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.05rem", fontWeight: 600 }}>Video Editing Collection</span>
            </div>
        ...
        <div className="reveal" style={{
          ...
          <div style={{ display: "flex", gap: "12px" }}>
            {[
              ...
              <button key={s.label} className="k2-social-btn" aria-label={`Bagikan ke ${s.label}`}>
                <i className={s.icon} />
              </button>
            ))}
          </div>
        ...
        <div className="reveal" style={{ padding: "60px 80px 100px" }}>
          <div style={{
            ...
            <p style={{ fontSize: "0.65rem", fontWeight: 600, letterSpacing: "0.28em", textTransform: "uppercase", color: "var(--accent2)", marginBottom: "16px", position: "relative", zIndex: 1 }}>
              Mau punya undangan digital yang benar-benar tak terlupakan?
            </p>
            <h3 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(2.2rem, 5vw, 4.5rem)", fontWeight: 300, lineHeight: 1.05, marginBottom: "18px", position: "relative", zIndex: 1 }}>
              Mari kita wujudkan<br />
              <em style={{ fontStyle: "italic", color: "var(--text-dim)" }}>momen pernikahanmu.</em>
            </h3>
            <p style={{ fontSize: "0.88rem", color: "var(--text-dim)", maxWidth: "420px", margin: "0 auto 36px", lineHeight: 1.78, position: "relative", zIndex: 1 }}>
              Ceritakan visi kamu — seberapa sederhana atau semeriah apapun. Saya siap mengubahnya menjadi pengalaman digital yang akan diingat setiap tamu yang membukanya.
            </p>
            <div style={{ display: 'flex', gap: '14px', flexWrap: 'wrap', justifyContent: 'center' }}>
              ...
              <a
                href="https://synnnw.github.io/SynnnW-Nikah/"
                target="_blank"
            ...
            <a
              href="#k2-gallery-section"
              style={{
                display: "inline-flex", alignItems: "center", gap: "10px",
                color: "var(--text)", background: "transparent",
                border: "1px solid var(--text-dim)", borderRadius: "99px",
                padding: "15px 40px", marginLeft: "16px",
                fontSize: "0.74rem", fontWeight: 700,
                letterSpacing: "0.15em", textTransform: "uppercase",
                transition: "all 0.3s ease", cursor: "pointer",
                textDecoration: "none", position: "relative", zIndex: 1,
              }}
              onMouseEnter={(e) => { e.currentTarget.style.color = "var(--accent)"; e.currentTarget.style.borderColor = "var(--accent)"; e.currentTarget.style.background = "rgba(139,92,246,0.08)"; }}
              onMouseLeave={(e) => { e.currentTarget.style.color = "var(--text)"; e.currentTarget.style.borderColor = "var(--text-dim)"; e.currentTarget.style.background = "transparent"; }}
            >
              <span>Cek Preview Website</span>
              <i className="fa-solid fa-eye" />
            </a>
          </div>
        </div>
