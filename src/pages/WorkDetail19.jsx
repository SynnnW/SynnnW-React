// src/pages/WorkDetail19.jsx
// Route: /works/parlemen-remaja-faza-2025
// SPECIAL: Instagram Reel + Firebase Drive Preview URL
...
// ─────────────────────────────────────────────────────────────
const DATA = {
  title:      'Parlemen Remaja 2025',
  titleSub:   'Faza Abdi Mahalila',
  year:       '2025',
  production: 'Kampanye Dapil Jawa Timur II',
  pembina:    null,
  ...
  instagramMain: 'https://www.instagram.com/reel/DNSDO_kTQNm/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==',
  instagramTrailer: 'https://www.instagram.com/reel/DOdFlsZCREV/?utm_source=ig_web_button_share_sheet',
...
export default function WorkDetail19({ lang = 'id' }) {
  ...
  // Load Drive preview URL from Firebase
  useEffect(() => {
    const loadDrivePreview = async () => {
      try {
        const docRef = doc(db, 'works-media', 'workDetail19');
  ...
  return (
    <div className="wd-page" ref={pageRef}>
      ...
      <section className="wd-section">
        <span className="wd-sec-label wd-reveal">01 / Video Campaign</span>
        <h2 className="wd-sec-title wd-reveal wd-d1">
          Watch the <em>Campaign.</em>
        </h2>
