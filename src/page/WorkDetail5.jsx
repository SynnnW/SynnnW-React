// src/pages/WorkDetail5.jsx
// Route: /works/sarka-2023
// TEMPLATE FILE — digunakan sebagai base untuk WorkDetail6 dst.
...
const DATA = {
  ...
  awards:     [], // SARKA tidak ada awards

  descEn: 'The first major short film from Sinematura — a story about Raka, a high schooler with a vision for waste management technology who faces ridicule and bullying from his peers. A film about not backing down when the world laughs at your ideas.',
  descId: 'Film pendek pertama Sinematura yang serius. Cerita tentang Raka, siswa SMA yang visioner soal pengolahan sampah tapi selalu dibully temen-temennya. Film tentang tetap berdiri waktu semua orang ketawa.',

  synopsis: 'Raka, seorang siswa SMA dengan ketertarikan di bidang pengolahan sampah, memiliki visi jauh ke depan. Ketika ia menyampaikan gagasan di kelas, teman-temannya terus mendebat dan membullynya — mengisi tasnya dengan sampah, melemparinya dengan botol bekas. Tapi Raka tidak gentar.',
  ...
  cast: null, // SARKA tidak menyebut cast di prompt
