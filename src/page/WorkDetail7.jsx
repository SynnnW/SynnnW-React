...
const DATA = {
  ...
  awards: [
    { icon: '🥈', event: 'FLS2N — Kabupaten Probolinggo', title: 'Juara 2' },
    { icon: '🏆', event: 'Film Festival Cendana 2025', title: 'Juara 1 Nasional' },
  ],

  descEn: 'Arka, 16, feels invisible to his workaholic parents. One fight at school forces a reckoning. He discovers martial arts, trains quietly, enters a competition in secret — and wins. A story about earning your own proof.',
  descId: 'Arka, 16 tahun, ngerasa jauh dari orang tuanya yang sibuk kerja. Satu perkelahian di sekolah jadi titik balik. Dia nemuin beladiri, latihan diam-diam, ikut lomba tanpa izin — dan menang. Cerita tentang buktiin sesuatu buat diri sendiri.',
  ...
  crew: [
    ...
    { role: 'Sekretariatan',   name: 'Robith Bil Haq Zidni Ilma' },
    { role: 'Astrada',         name: 'Erika Puspita Sari' },
    ...
    { role: 'Wardrop',         name: 'Diva Triwahyuningsih' },
    ...
    { role: 'Cameraman',       name: 'Zafa Islamay Pratama P., Alvarel Bagasdika P.' },
  ],

  cast: [
    'Muhammad Emir Pandiga',
    'Muhammad Cholili',
    'Eva Early Nur Hidayati S.T,M.,Pd.',
    'Almarhum Hari Sampurno S.Pd.',
    'Nining Jumariyati S.Si.',
    'Juhari M.Pd.',
    'Raditya Aryasatya Ramadhani',
  ],
