...
const DATA = {
  ...
  pembina:    null, // Film pertama — belum ada pembina
  editor:     'Akhdan Hafiz Anugrah',
  youtubeId:  '7BBXPscn8cA',
  badges:     ['Short Film', 'Video'],
  awards:     [],

  descEn: 'The very first short film — before there was a club, before there were awards. Pak Rehan is a school groundskeeper, 35 years old with three kids, who wants to apply for a civil servant position but struggles with technology. A story about learning to adapt, one app at a time.',
  descId: 'Film pertama yang pernah dibuat — sebelum ada komunitas, sebelum ada penghargaan. Pak Rehan, petugas kebun sekolah yang pengen daftar CPNS tapi belum ngerti handphone. Cerita tentang belajar teknologi dari nol, sambil tetap nyemangatin keluarga.',

  synopsis: null,

  // Note khusus — ditampilkan sebagai info card
  firstFilmNote: true,

  crew: [
    { role: 'Production Manager', name: 'Rizha Nur Hidayah Putri' },
    { role: 'Director',           name: 'Robith Bil Haq Zidni Ilma' },
    { role: 'DOP',                name: 'Ibni Gio Vanni Yafi' },
    { role: 'Cameraman',          name: 'Hermawan Ibra Wicaksono' },
    { role: 'Asst. Cameraman',    name: 'Aldo Leo Saputra' },
    { role: 'Scriptwriter',       name: 'Fikriyyah Putri Salsabila' },
  ...
  cast: [
    'Tatag Dwi Prasetya (Mr. Rehan)',
    'Naura Lintang Aliandya (Mrs. Dini)',
    'Royfando Bryanda Arkananta (Aldo)',
    'Erika Puspita Sari (Mega)',
    'Ummi Zamzamah Firdausyah (Sari)',
  ],
  ...
  return (
    <div className="wd-page" ref={pageRef}>
      ...
      <section className="wd-section">
        ...
        {/* Note: Film pertama — no supervisor */}
        {d.firstFilmNote && (
          <div className="wd-solo-card wd-reveal wd-d3">
            <i className="fa-solid fa-seedling" />
            <p>
              <strong>Film pertama Sinematura</strong> — dibuat sebelum ada pembina, sebelum ada komunitas resmi, dan sebelum ada penghargaan. Pramu Rasa adalah titik awal dari semua yang kemudian berkembang.
            </p>
          </div>
        )}
