// src/pages/WorkDetail9.jsx
// Route: /works/luka-menjadi-lukisan-2024
// SOLO PROJECT — no Sinematura badge
...
const DATA = {
  ...
  descEn: 'A solo project — written, shot, and edited by one person. A student artist who gets mocked for his craft decides to turn that noise into motivation. The kind of film you make when you have a point to prove.',
  descId: 'Proyek solo — nulis, nge-shoot, ngedit sendiri. Seorang siswa yang suka seni terus-terusan dikomenin orang, terus jadiin itu bahan bakar buat dapetin pengakuan. Film yang dibuat waktu ada sesuatu yang harus dibuktiin.',

  synopsis: null,

  isSoloProject: true,
  soloNote: 'Solo production — satu orang menangani seluruh aspek produksi: penulisan naskah, sinematografi, dan editing.',

  crew: [
    { role: 'Editor / Writer / Cameraman', name: 'Aldo Leo Saputra' },
  ],

  cast: null,

  sinematura: null, // Solo project — no sinematura badge
};
  ...
  return (
    <div className="wd-page" ref={pageRef}>
      ...
      <section className="wd-section">
        ...
        {/* Sinematura badge — hanya jika bukan solo project */}
        {d.sinematura && (
