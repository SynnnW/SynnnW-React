...
const DATA = {
  ...
  // Kompetisi hasil: Urutan 5 (tetap tampilkan, jujur)
  competition: 'Video Moderasi Beragama — #VidioPAISLoveFestival2024',
  awards:     [
    { icon: '5️⃣', event: '#VidioPAISLoveFestival2024', title: 'Urutan 5' },
  ],

  descEn: 'A story about a religious minority student fighting to hold a Christmas event at his school, and the unexpected ally who makes it happen. A film about how tolerance isn\'t just a concept — it\'s a decision people have to make together.',
  ...
  crewNote: '30+ crew — full credit list available on request',
    ...
    <div className="wd-page" ref={pageRef}>
      ...
      {d.crew && d.crew.length > 0 && (
        <section className="wd-section">
          ...
          {d.crewNote && (
            <p className="wd-reveal wd-d3" style={{ fontSize: '0.78rem', color: 'var(--text-dim)', marginTop: 16, fontStyle: 'italic', lineHeight: 1.7 }}>
              {d.crewNote}
            </p>
          )}
        </section>
